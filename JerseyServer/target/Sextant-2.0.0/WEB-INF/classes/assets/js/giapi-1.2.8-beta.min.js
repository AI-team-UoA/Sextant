...
GIAPI.TermFrequencyWidget=function(e,t,r,i){var n={},d={};return n.init=function(){for(var n=0;n<e.length;n++){var l=t.targets()[n];d[e[n]]=l}for(var n=0;n<e.length;n++){var c=e[n],l=t.targets()[n];jQuery("#"+c).jtable({title:l.toUpperCase(),selecting:!0,multiselect:!0,selectingCheckboxes:!0,selectOnRowClick:!1,fields:{term:{visibility:"hidden"},decodedTerm:{title:"",width:"80%"},freq:{title:"",width:"20%"}},selectionChanged:function(){{var e=jQuery("#"+this.id).jtable("selectedRows");this.id}if(e.length>0){if(e[e.length-1].ignoreEvent)return delete e[e.length-1].ignoreEvent,void 0;var n=[];e.each(function(){var e=jQuery(this).data("record");n.push(e)}),t.checkItems(d[this.id],n),t.discover(),i&&i.apply(this,[])}else{r&&r.apply(this,[]);var l=d[this.id];t.clearCheckedItems(l),t.discover(),i&&i.apply(this,[])}},rowInserted:function(e,r){t.isCheckedItem(d[e.target.id],r.record)&&(r.row[0].ignoreEvent=!0,jQuery("#"+c).jtable("selectRows",r.row))}}),jQuery(".jtable thead").remove();var s=t.checkedItems(l);if(s)for(var a=0;a<s.length;a++)jQuery("#"+c).jtable("addRecord",{record:s[a],clientOnly:!0});for(var s=t.items(l),a=0;a<s.length;a++)t.isCheckedItem(l,s[a])||jQuery("#"+c).jtable("addRecord",{record:s[a],clientOnly:!0})}},n};